...
--
-- Database: phyinfo
-- Generation Time: 2023-12-02 12:53:36.9790
-- -------------------------------------------------------------
...
CREATE SEQUENCE IF NOT EXISTS buildings_building_id_seq;

-- Table Definition
CREATE TABLE "public"."buildings" (
    "building_id" int4 NOT NULL DEFAULT nextval('buildings_building_id_seq'::regclass),
...
-- Sequence and defined type
CREATE SEQUENCE IF NOT EXISTS electricity_consumption_consumption_id_seq;

-- Table Definition
CREATE TABLE "public"."electricity_consumption" (
    "consumption_id" int4 NOT NULL DEFAULT nextval('electricity_consumption_consumption_id_seq'::regclass),
    "building_id" int4,
    "month" date,
...
-- Sequence and defined type
CREATE SEQUENCE IF NOT EXISTS waste_mgmt_waste_id_seq;

-- Table Definition
CREATE TABLE "public"."waste_mgmt" (
    "waste_id" int4 NOT NULL DEFAULT nextval('waste_mgmt_waste_id_seq'::regclass),
    "building_id" int4,
    "month" date,
...
INSERT INTO "public"."buildings" ("building_id", "building_name", "total_floors", "has_lift", "num_lights", "num_fans", "num_doors", "num_windows") VALUES
...
INSERT INTO "public"."electricity_consumption" ("consumption_id", "building_id", "month", "consumption_kwh", "renewable_percentage") VALUES
...
INSERT INTO "public"."waste_mgmt" ("waste_id", "building_id", "month", "total_waste_kg", "recycled_waste_kg", "non_recyclable_waste_kg") VALUES
...
ALTER TABLE "public"."electricity_consumption" ADD FOREIGN KEY ("building_id") REFERENCES "public"."buildings"("building_id");
ALTER TABLE "public"."waste_mgmt" ADD FOREIGN KEY ("building_id") REFERENCES "public"."buildings"("building_id");
